...
<Gotchas>
- <strong>Empty Explorer panel.</strong> Project mismatch &mdash; the project selector at the top of the Console isn&rsquo;t set to your Garage&rsquo;s project. Switch it.
...
- <strong><code>gemini</code> connection missing.</strong> Same as above &mdash; pre-provisioning issue.
...
- <strong>Studio shows the wrong project in the SQL editor header.</strong> Check the project selector at the top of the Console &mdash; Studio uses whatever&rsquo;s selected there for default table resolution.
</Gotchas>
